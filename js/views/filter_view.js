...
app.FilterView = Backbone.View.extend({
	allFilters: [
		{name: 'Noodles', text: 'Noodles', selected: true},
		{name: 'French Fries', text: 'French Fries', selected: true},
		{name: 'rice plates', text: 'rice plates', selected: true},
		{name: 'drinks and juices', text: 'drinks and juices', selected: true},
		{name: 'Meat and vegi rice bowls', text: 'Meat and vegi rice bowls', selected: true},
		{name: 'sandwich', text: 'Sandwich', selected: true},
		{name: 'Funghi', text: 'Funghi', selected: true}
	],
	searchString: '',
	el: '#filters',
	events: {
